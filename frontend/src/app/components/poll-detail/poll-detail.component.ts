      ...
      <div class="max-w-2xl mx-auto">
        ...
        >
          <div nz-result-extra>
            <button
              nz-button
              nzType="primary"
              class="rounded-xl bg-indigo-600 border-none"
              (click)="goHome()"
            >
              Back to Home
            </button>
        ...
        <div class="mb-6">
          <button
            nz-button
            nzType="text"
            class="text-gray-400 hover:text-gray-700 mb-3 -ml-2 flex items-center gap-1"
            (click)="goHome()"
          >
          ...
          <div class="flex items-start justify-between gap-4">
            ...
            <nz-tag
              nzColor="geekblue"
              class="flex-shrink-0 mt-1 rounded-lg text-sm font-semibold px-3 py-1"
            >
          ...
          <!-- Poll ID chip -->
          <div
            class="mt-3 inline-flex items-center gap-2 bg-white border border-gray-200 px-3 py-1.5 rounded-lg shadow-sm"
          >
            ...
            <button
              class="text-gray-400 hover:text-indigo-500 border-none bg-transparent cursor-pointer p-0 transition-colors"
              (click)="copyId()"
            >
          ...
          >
            ...
            <div class="relative flex items-center justify-between px-5 py-4 gap-4">
              ...
              <div class="flex items-center gap-3 min-w-0">
                <div
                  class="flex-shrink-0 w-9 h-9 rounded-xl bg-indigo-100 group-hover:bg-indigo-200 text-indigo-700 font-extrabold flex items-center justify-center text-base transition-colors"
                >
                ...
                <div class="min-w-0">
                  <p class="font-semibold text-gray-800 text-base mb-0 truncate">
                    {{ option.title }}
                  </p>
              ...
              <div class="flex-shrink-0 text-right">
                ...
                <p class="text-xs text-gray-400 mb-0 tabular-nums">
