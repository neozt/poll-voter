...
@Component({
  ...
  template: `
    <div class="max-w-4xl mx-auto p-4 md:p-8">
      <h1
        nz-typography
        class="text-3xl font-bold mb-8 text-center bg-gradient-to-r from-blue-600 to-indigo-600 text-transparent bg-clip-text"
      >
        Active Polls
      </h1>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          <p nz-typography nzType="secondary" class="mb-6 whitespace-pre-wrap">
            {{ poll.description }}
          </p>
            ...
            <div class="p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
              ...
              <div class="mt-2">
                <div class="flex justify-between text-xs text-gray-500 mb-1">
                  <span
                    >{{ option.vote_count || 0 }}
                    {{ option.vote_count === 1 ? 'vote' : 'votes' }}</span
                  >
                  <span
                    >{{
                      calculatePercentage(poll, option.vote_count || 0) | number : '1.0-0'
                    }}%</span
                  >
                </div>
                <nz-progress
          ...
          <div
            class="mt-4 pt-4 border-t border-gray-100 flex justify-between text-xs text-gray-400"
          >
